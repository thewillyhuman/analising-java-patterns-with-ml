SELECT programs.program_id as program__program_id,
       ...
       expressions.nodetype_id as expressions__node_id,
       expressions.expression_category as expressions__syntactic_category,
       expressions.firstchild as expressions__syntactic_category_first_child,
       expressions.secondchild as expressions__syntactic_category_second_child,
       expressions.thirdchild as expressions__syntactic_category_third_child,
       expressions.parentnode as expressions__syntactic_category_parent_node,
       expressions.parentchild as expressions_role_played_in_parent_node,
       expressions.height as expressions__height,
       expressions.depth as expressions__depth,
       expressions.user_id as expressions__user_id,
       expressions.user_class as expressions_user_class
...
RIGHT JOIN statement as statements ON parent_method.node_id = statements.nodetype_id
RIGHT JOIN nodes_parent_statement as parent_statement ON statements.nodetype_id = parent_statement.node_id_of_parent_statement
JOIN expression as expressions ON parent_statement.node_id = expressions.nodetype_id
