...
FROM program programs,
     ...
     "type" types
WHERE programs.program_id = file.program_id
  and file.file_id = type_defs.file_id
  AND n1.parentnode_id = type_defs.nodetype_id
  and n1.nodetype_id = field_defs.nodetype_id
  AND n2.parentnode_id = field_defs.nodetype_id
  and n2.nodetype_id = "types".nodetype_id;